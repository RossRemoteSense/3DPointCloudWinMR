...
namespace IATK
{
    ...
    public class ViewBuilder
    {
        ...
        private List<Vector3> uv2s;                                 // Holds extra data such as previous positions
        private List<Vector4> tangents;                             // Holds extra data such as animation direction, distance
        ...
        public ViewBuilder initialiseDataView(int numberOfPoints)
        {
            ...
            tangents = new List<Vector4>(numberOfPoints);
        ...
        public ViewBuilder setDataDimension(IEnumerable<float> data, VIEW_DIMENSION dimension)
        {
            Debug.Assert((int)dimension < 3);
            //Debug.Assert(data.Count() <= positions.Count);
        ...
        public View apply(GameObject parent, Material material)
        {
            ...
            //dirty: copying data after creation...
            //meshObject.myMeshData = data;

            meshObject.NB_VERTTICES = data.vertices.Length;
