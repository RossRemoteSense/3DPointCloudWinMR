            ...
            if (viewList.Count != 0)
                switch (propertyType)
                {
                    ...
                    case AbstractVisualisation.PropertyType.Y:
                        ...
                        break;
                    case AbstractVisualisation.PropertyType.XY:
                        viewList[0].UpdateXYPositions(visualisationReference.dataSource[visualisationReference.xDimension.Attribute].Data, 
                        visualisationReference.dataSource[visualisationReference.yDimension.Attribute].Data);
                        viewList[0].TweenPosition();
                        break;
                    ...
                    case AbstractVisualisation.PropertyType.Colour:
                        ...
                        break;
                    case AbstractVisualisation.PropertyType.DirectionAnimations:
                        //viewList[0].BigMesh.updateBigMeshTangents(null);
                        break;
